...
\quote{``Este PDF también es un \textbf{bootloader}.\\\href{https://cv.kike.wtf}{Compruébalo pulsando aquí}."}
%-------------------------------------------------------------------------------
\begin{document}
\makecvheader
...
\begin{cventries}
  ...
  \cventry
    ...
    {Escuela Superiot de Ingeniería de Telecomunicaciones (Universidade de Vigo)} % Organization
    {Vigo, Galicia} % Location
